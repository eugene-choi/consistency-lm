...
def main():
    ...
    parser.add_argument(
        "--dataset-path",
        type=str,
        default="/scratch/ec2684/research/consistency-lm/training_data/wikitext103_raw_gpt2bpe.pkl"
    )
    parser.add_argument(
        "--cache-dir",
        type=str,
        default="/scratch/ec2684/research/consistency-lm/models/transformers_cache"
    )
    parser.add_argument(
        "--save-base-dir",
        default='/scratch/ec2684/research/consistency-lm/checkpoint/self_terminating/gpt2/',
        type=str
    )
    parser.add_argument(
        '--eval-split',
